...
export default function PopupEnquiry() {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[99997] flex items-center justify-center p-4 md:p-6"
      role="dialog"
      aria-modal="true"
    ...
    >
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-navy-deep/75 backdrop-blur-sm animate-[fadeIn_0.4s_ease]"
        onClick={close}
      />
      ...
      >
        ...
        <button
          ...
          aria-label="Close"
          className="absolute top-3 right-3 z-20 w-9 h-9 inline-flex items-center justify-center text-cream md:text-cream bg-navy-deep/50 hover:bg-navy-deep border border-gold/40 hover:border-gold transition-colors"
        >
          <X size={16} />
        </button>
        ...
        <div className="relative bg-navy-deep text-cream p-7 md:p-10 overflow-hidden">
          ...
          <div className="relative">
            ...
            <h3 className="font-display text-cream text-[1.7rem] md:text-[2.1rem] lg:text-[2.4rem] leading-[1.06]" data-cms-path="popup.title">
              {popup.title || 'Get a personal call back within one working day.'}
            </h3>
            <p className="font-editorial text-cream/80 text-[1.05rem] leading-relaxed mt-5" data-cms-path="popup.subtitle">
            ...
            <ul className="mt-7 space-y-3">
              {(popup.bullets || [
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="font-editorial text-cream/90 text-[1rem]" data-cms-path={`popup.bullets.${i}`}>{b}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        {/* RIGHT — form */}
        <div className="p-7 md:p-10 bg-cream relative">
          {sent ? (
            <div className="h-full flex flex-col items-center justify-center text-center min-h-[360px] py-10">
